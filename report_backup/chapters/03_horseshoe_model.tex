...
remaining diagnostics -- trace and autocorrelation plots for the other $\beta$
and $\lambda$ parameters, with the full Gelman--Rubin and effective-sample-size
tables -- were inspected in the accompanying notebook
(\texttt{03\_feature\_selection.Rmd}) and are not reproduced here.
