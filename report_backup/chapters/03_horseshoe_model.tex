...
in Appendix~\ref{app:mcmc_horseshoe}, are deliberately modest given the
...
adequate for the summaries we report. The
complete diagnostic material - representative trace plots for each block, all
autocorrelation plots for both the
