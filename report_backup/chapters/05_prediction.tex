...
would trade for one retained customer.
...
scale tested, \emph{Business} class follows, and among the fourteen service
items \emph{Inflight entertainment} is the one the prior preserves most
clearly, while \emph{Inflight wifi service} and \emph{Gate location} are
heavily shrunk despite sitting in the same correlated clusters. That asymmetry
is what the horseshoe was chosen for.
