...
essentially tied ($\kappa_j = 0.17$ and $0.18$). Entertainment is the service
...
unseen customers, the model reaches an AUC of $0.900$, classifies $82.8\%$
correctly, and reproduces the observed satisfaction rate in every subgroup.
