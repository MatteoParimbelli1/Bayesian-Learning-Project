...
Section~\ref{sec:regression}. Tables~\ref{tab:hs-kappa}
and~\ref{tab:hs-signal} give the values and the resulting verdicts at each of
the three global scales tested in Section~\ref{sec:sens-horseshoe}.
