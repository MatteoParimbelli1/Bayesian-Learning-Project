...
The brief describes a curated 1,000-row file; we have the full `r format(dim(raw)[1], big.mark = ",")`-row source. We draw a stratified training subsample of $n \approx 1{,}200$, and we stratify it to reflect categorical variable classes proportions.
