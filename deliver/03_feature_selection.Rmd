...
**`Class: Business` shrinks once service quality is in the model.** In Section 02, Business class alone carried an odds ratio of about 4.1. Here, with all 14 service ratings included, its coefficient drops to `r kappa_tbl$beta_mean[kappa_tbl$term=="Class: Business"]` ($\kappa=$ `r kappa_tbl$kappa[kappa_tbl$term=="Class: Business"]`). The natural reading is mediation, not disappearance: Business passengers are more satisfied largely *because* they experience better seat comfort, entertainment, and service -- `Class` was partly standing in for those ratings in Section 02 simply because they weren't in the model yet.
